...
│                         │  Cypher Query:          │                │
│                         │  MATCH (a:Algorithm)    │                │
│                         │  WHERE a.name="RSA-2048"│                │
│                         │  RETURN a, relationships│                │
│                         └───────────┬─────────────┘                │
│                                     │                               │
├─────────────────────────────────────┼─────────────────────────────┤
│         KNOWLEDGE GRAPH             │   VECTOR DATABASE           │
│  (Neo4j - Structured Relationships) │  (FAISS - Semantic Search)  │
├─────────────────────────────────────┼─────────────────────────────┤
│                                     │                               │
│  ┌─────────────────┐                │  ┌─────────────────┐        │
│  │  NIST SP 800-57 │────┐           │  │Embedded Docs:   │        │
│  │  (Standard)     │    │           │  │• NIST PDFs      │        │
│  └─────────────────┘    │           │  │• RFCs           │        │
│          │              │           │  │• Whitepapers    │        │
│          ▼              │           │  └────────┬────────┘        │
...
│                         ┌───────────────────────────────────────┐ │
│                         │         ANSWER GENERATION             │ │
│                         │  Answer: "RSA-2048 provides 112-bit   │ │
│                         │  security, acceptable until 2030 per  │ │
│                         │  NIST guidelines. Consider RSA-3072   │ │
│                         │  for long-term use."                  │ │
│                         │  Citations: [NIST SP 800-57, PCI DSS] │ │
│                         └─────────────────┬─────────────────────┘ │
│                                           │                       │
│                         ┌─────────────────▼─────────────────┐     │
│                         │         FEEDBACK LOOP             │     │
│                         │  • Update query cache             │     │
│                         │  • Enhance graph relationships    │     │
